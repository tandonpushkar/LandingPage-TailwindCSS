...
export default function footer() {
    return (
        <footer className="bg-purple-200 text-white body-font">
            ...
            <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-no-wrap flex-wrap flex-col">
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a href="/" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        ...
                        <span className="ml-3 font-bold text-xl"> Pushkar Tandon</span>
                    </a>
                    <p className="mt-2 text-sm text-gray-900">Made with <span role="img" aria-label="love" >💘</span> using tailwindcss and react</p>
                </div>
            ...
            <div className="bg-purple-600">
                <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2020 tandonpushkar —
        <a href="https://tandonpushkar.netlify.app" rel="noopener noreferrer" className="text-gray-400 ml-1" target="_blank">@portfolio</a>
                    </p>
